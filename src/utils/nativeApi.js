/**
 * Native Automa API functions
 *
 * These functions were originally in api.js and call old Automa API endpoints.
 * They are preserved here for potential future use but are currently disabled
 * (the features that use them — shared workflows, backup, Google OAuth — are hidden).
 */
import BrowserAPIService from '@/service/browser-api/BrowserAPIService';
import { parseJSON } from './helper';
import { fetchApi, cacheApi } from './api';
